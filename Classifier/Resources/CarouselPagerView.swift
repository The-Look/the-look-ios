...
class ImageCarouselView: UIView {
    ...
    var didOpenPage: ((_ page: Int) -> Void)?
    ...
    func setupView() {
        ...
        carouselScrollView.addGestureRecognizer(gesture)
    }
    ...
    func addPageControl() {
        if images.count <= pageControlMaxItems {
            ...
            pageLabel.font = UIFont.systemFont(ofSize: 10, weight: .light)
