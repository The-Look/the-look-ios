...
class AdsList: UIViewController, GADBannerViewDelegate /*CLLocationManagerDelegate*/ {
...
//extension AdsList:UIScrollViewDelegate {
...
//                self.appNameLabelView.alpha = 1.0
//
//            }
//
//        }
...
//
//            UIView.animate(withDuration: 1) {
//                self.appNameLabelView.alpha = 0.0
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        userPointer.fetchIfNeededInBackground(block: { (user, error) in
            if error == nil {
                ...
                let imageFileAvatar = userPointer[USER_AVATAR] as? PFFile
