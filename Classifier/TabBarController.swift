...
class TabBarController: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        setImage(#imageLiteral(resourceName: "tb_home_icon"), selectedImage: #imageLiteral(resourceName: "tb_home_selected_icon"), title: "Home", forPage: .home)
        setImage(#imageLiteral(resourceName: "tb_explore_icon"), selectedImage: #imageLiteral(resourceName: "tb_explore_selected_icon"), title: "Explore",  forPage: .explore)
        setImage(#imageLiteral(resourceName: "tb_add"), selectedImage: #imageLiteral(resourceName: "tb_add"), title: nil,  forPage: .addItem)
        setImage(#imageLiteral(resourceName: "tb_activity_icon"), selectedImage: #imageLiteral(resourceName: "tb_activity_selected_icon"), title: "Notifications",  forPage: .activity)
        setImage(#imageLiteral(resourceName: "tb_user_icon"), selectedImage: #imageLiteral(resourceName: "tb_user_selected_icon"), title: "Profile",  forPage: .account)
